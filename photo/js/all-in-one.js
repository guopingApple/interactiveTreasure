...
var A = Best.hg.extend({
        ...
        PΝ: function (Β, Ϝ, І) {
            ...
            Β.drawImage(this.Zl, this.width - this.Zl.width >> 1, U-200);
            Β.globalAlpha = 1
        },
        Аi: function () {
            var W = this;
...
var Н = Best.hg.extend({
        ...
        ΗZ: function (V, Ρ, O) {
            this.Qi += Ρ;
            V.fillStyle = "rgba(0,0,0,0.8)";
            V.fillRect(0, 0, this.width, this.height);
            V.drawImage(this.ΙY, 0, this.height - this.ΙY.height - 300 >> 1,this.width,Math.floor(this.width*this.ΙY.height/this.ΙY.width));
            var Α = ">> 点击继续 <<";
            var Ε = 40;
            V.font = Ε + "px Heiti";
            V.fillStyle = "#cccccc";
...
var M = Best.hg.extend({
        ...
        uf: function () {
            if (!M.ng) {
                var q = M.ng = t.ІJ(500, 280, 50, "rgba(255,255,255,1)");
                var А = q.getContext("2d");
                var g = 50;
                А.font = g + "px Heiti";
                А.fillStyle = "rgba(0,0,0,1)";
                А.fillText("最终得分 : ", 60, 130)
            }
            this.ng = M.ng
        },
        hA: function () {
